...
primes_list = sieve_of_eratosthenes(100*10)
print("The first hundred prime numbers are:", end=" ")
for i, num in enumerate(primes_list):
    print(num, end=", "*(i!=99)) # Print comma separated values except for the last one.

print("")
print("count=", len(primes_list))
# Output: 4
